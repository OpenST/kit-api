...
export KA_DEFAULT_DB_PASSWORD=root

export KA_SUB_ENV_SHARED_DB_HOST=127.0.0.1
export KA_SUB_ENV_SHARED_DB_USER=root
export KA_SUB_ENV_SHARED_DB_PASSWORD=root

export KA_SAAS_DEFAULT_DB_HOST=127.0.0.1
export KA_SAAS_DEFAULT_DB_USER=root
export KA_SAAS_DEFAULT_DB_PASSWORD=root

export KA_SAAS_SHARED_DB_HOST=127.0.0.1
export KA_SAAS_SHARED_DB_USER=root
export KA_SAAS_SHARED_DB_PASSWORD=root

export KA_SAAS_BIG_DB_HOST=127.0.0.1
export KA_SAAS_BIG_DB_USER=root
export KA_SAAS_BIG_DB_PASSWORD=root

export KA_SAAS_DB_HOST=127.0.0.1
export KA_SAAS_DB_USER=root
export KA_SAAS_DB_PASSWORD=root

export KA_CONFIG_DB_MYSQL_HOST=127.0.0.1
export KA_CONFIG_DB_MYSQL_USER=root
export KA_CONFIG_DB_MYSQL_PASSWORD=root
