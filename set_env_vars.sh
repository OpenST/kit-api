...
export KA_KIT_SAAS_REDEMPTION_SUBENV_MYSQL_HOST=127.0.0.1
export KA_KIT_SAAS_REDEMPTION_SUBENV_MYSQL_USER=root
export KA_KIT_SAAS_REDEMPTION_SUBENV_MYSQL_PASSWORD=root
