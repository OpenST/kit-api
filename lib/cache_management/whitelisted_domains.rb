module CacheManagement
  ...
  # This cache has list of domains which are allowed for Access KIT 2.0. SHOULD NOT BE SENT TO FE
  ...
  class WhitelistedDomains
    ...
    def fetch
      ...
      data_to_cache = Memcache.get_set_memcached(get_cache_key, get_cache_expiry) do
        {domains: ManagerWhitelisting.where(
    ...
    def memcache_key_object
      @m_k_o ||= MemcacheKey.new('manager.whitelisted_domains')
    end
