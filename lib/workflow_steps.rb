class WorkflowSteps
  ...
  def fetch_economy_setup_config(workflow_kind)
    ...
    when GlobalConstant::Workflow.grant_eth_stake_currency
      @step_config = GlobalConstant::WorkflowStatus.grant_eth_stake_currency_step_config
      @group_config = GlobalConstant::WorkflowStatus.grant_eth_stake_currency_group_config
    else
